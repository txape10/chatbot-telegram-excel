...
EDITOR_DSL_SISTEMA = (
    ...
    "  añadir_columna     → nueva columna calculada. Dos formas:\n"
    "    · Simple (dos operandos): 'nombre', 'col1', 'operador' (+,-,*,/), 'col2' o 'valor_fijo'.\n"
    "    · Expresión (3+ operandos): 'nombre' y 'expresion' (ej. \"Base * IVA_Pct / 100\").\n"
    "    USA 'expresion' cuando la fórmula combine más de dos factores o columnas.\n"
